...
## Quarto install or upgrade

Quarto enables you to weave together content and executable code into a finished document. To learn more about Quarto see https://quarto.org .

```{.bash filename="terminal-brew"}
...
For ojs and pkp (public knowledge project) install packages first. follow this [pkp installation guide](https://typeset.io/resources/how-to-install-ojs-a-step-by-step-guide/){target="_blank"}.  \
