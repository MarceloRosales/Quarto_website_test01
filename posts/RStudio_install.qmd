...
new_folder <- "Rpkgs230522/" #change name accordingly, dont forget the "/".
...
folder_file <- paste0(folder, new_folder, file_name) #use paste0(), paste() inserts a space between obj.
rda <- ".rda"
csv <- ".csv"
df <- "_df"
xlsx <- ".xlsx"
...
#Generic
# save only the Package (column) variable as vector?, or as full csvdata frame
