...
#　3. Once the new version up and running, reload the saved packages and re-install them from CRAN.
...
A solution: For english: [Installing R on Mac - Warning messages: Setting LC_CTYPE failed, using "C"](https://stackoverflow.com/questions/9689104/installing-r-on-mac-warning-messages-setting-lc-ctype-failed-using-c)
