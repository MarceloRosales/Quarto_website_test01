...
# C. Backup your preferences file
source_path <- "/Users/marcelorosales/.config/rstudio/rstudio-prefs.json"
destination_path <- "/Users/marcelorosales/Box Sync/Github/RStudio_shared/RS_preferences/"
...
new_folder <- "Rpkgs230522/" # <----------------change name accordingly, don't forget the "/".
...
file_name <- "Rpkgs_MBP20_230522" # <------------change name accordingly.
rda <- ".rda"
csv <- ".csv"
df <- "_df"
xlsx <- ".xlsx"
...
# Generic code: Use this method because it is easy to change the names of the variables in one place once.
...
# Specific code: Do not use this method because requires changing the name of the file in each instance, and paths are also troublesome.
